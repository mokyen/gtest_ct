...
**R1**: WHEN compiling with GCC 9 or greater, the system SHALL support C++11, 14, 17, 20, and 23 standards.

**R2**: WHEN compiling with Clang 13 or greater, the system SHALL support C++11, 14, 17, 20, and 23 standards.
...
- **Broad Compiler Support**: Works with GCC 9+ and Clang 13+ across C++11 through C++23
